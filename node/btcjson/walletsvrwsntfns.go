...
const (
	...
	// PearldConnectedNtfnMethod is the method used for notifications when
	// a wallet server is connected to a chain server.
	PearldConnectedNtfnMethod = "pearldconnected"
...
// PearldConnectedNtfn defines the pearldconnected JSON-RPC notification.
type PearldConnectedNtfn struct {
	Connected bool
}

// NewPearldConnectedNtfn returns a new instance which can be used to issue a
// pearldconnected JSON-RPC notification.
func NewPearldConnectedNtfn(connected bool) *PearldConnectedNtfn {
	return &PearldConnectedNtfn{
		Connected: connected,
	}
}
...
func init() {
	...
	MustRegisterCmd(PearldConnectedNtfnMethod, (*PearldConnectedNtfn)(nil), flags)
