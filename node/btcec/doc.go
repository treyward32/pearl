...
/*
Package btcec implements support for the elliptic curves needed for Pearl.

Pearl uses elliptic curve cryptography using koblitz curves
...
standard formats.  It was designed for use with pearld, but should be
