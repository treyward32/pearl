...
/*
Package wire implements the Pearl wire protocol.
...
a remote peer node.  Example syntax is:
	...
	// protocol version pver and the network prlnet.  The returns
...
from a remote peer is:
	...
	// pver, and the network prlnet.  The return is a possible
	// error.
